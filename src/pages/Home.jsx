        ...
        <div className="container home-hero-container">
          <div className="home-hero-content animate-fade-in-up">
            <div className="home-hero-badge">
              <span><span className="brand-name">Portábell<span className="brand-y">y</span></span> de portas abertas para o futuro</span>
            </div>
            <h1 className="home-hero-title font-walkway">
              Portas ALVORADA e <span className="brand-name">Portábell<span className="brand-y">y</span></span> <span className="title-accent">uniram-se</span>
            </h1>
      ...
      <section className="home-pillars">
        <div className="container">
          <div className="home-section-header reveal reveal-fade-in-up">
            ...
            <h2 className="home-section-title font-walkway">Por Que Escolher a <span className="brand-name">Portábell<span className="brand-y">y</span></span>?</h2>
      ...
      <section className="home-transition-teaser">
        <div className="container teaser-container">
          ...
          <div className="teaser-content reveal reveal-fade-in-right">
            ...
            <h2 className="teaser-title font-walkway"><span className="brand-name">Portábell<span className="brand-y">y</span></span> Indústria de Portas vem renovada</h2>
